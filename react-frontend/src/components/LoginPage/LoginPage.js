...
import discountIllustrationsvg from "../../assets/media/Free Discount.svg";
import loyaltyIllustrationsvg from "../../assets/media/Loyalty.svg";
  ...
  return (
    <div className="flex flex-col min-h-screen align-items-center justify-content-center background-image">
      ...
      <div className="absolute bottom-0 left-0 flex justify-between w-full px-10 py-10 z-[-1]">
        <img
          src={loyaltyIllustrationsvg}
          alt="loyaltyIllustrationsvg"
          className="w-20rem min-w-[150px]"
        />
        <img
          src={discountIllustrationsvg}
          alt="discountIllustrationsvg"
          className="w-20rem min-w-[150px]"
        />
      </div>
      <AppFooter />
