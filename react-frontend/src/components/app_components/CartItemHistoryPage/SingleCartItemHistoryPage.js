...
const SingleCartItemHistoryPage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      ...
      .get(urlParams.singleCartItemHistoryId, {
        query: {
          $populate: [
            {
              path: "createdBy",
      ...
      .then((res) => {
        ...
        const user = Array.isArray(res.user)
          ? res.user.map((elem) => ({ _id: elem._id, username: elem.username }))
          : res.user
            ? [{ _id: res.user._id, username: res.user.username }]
            : [];
        setUser(user);
        ...
        <div className="col-12">
          ...
          <div className="card w-full">
            <div className="grid ">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">Voucher</label>
                {voucher.map((elem) => (
