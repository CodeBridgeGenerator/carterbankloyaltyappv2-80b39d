...
const DocumentationDetailsCreateDialogComponent = (props) => {
    ...
    client
      ...
      .find({
        query: {
          $limit: 10000,
          $sort: { createdAt: -1 },
          _id: urlParams.singleDocumentStoragesId,
        },
      })
      .then((res) => {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Edit info",
        message: "Info documentationDetails updated successfully",
      });
  ...
  const documentationFileOptions = documentationFile.map((elem) => ({
    name: elem.name,
    value: elem.value,
  }));
  ...
  return (
    <Dialog
      header="Edit Documentation Details"
      visible={props.show}
      closable={false}
      onHide={props.onHide}
      modal
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="documentationDetails-edit-dialog-component"
      >
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Dropdown
              ...
              value={_entity?.documentationFile?._id}
              optionLabel="name"
              optionValue="value"
              options={documentationFileOptions}
              onChange={(e) =>
                setValByKey("documentationFile", { _id: e.value })
              }
            />
          </span>
          <small className="p-error">
...
export default connect(
  mapState,
  mapDispatch,
)(DocumentationDetailsCreateDialogComponent);
