...
This document provides an in-depth look into the workflows that drive the application, focusing on how they simplify operations while maintaining accountability and transparency.`,
  ...
  const parseHtmlContent = (html) => {
    ...
    while ((olMatch = olRegex.exec(cleanHtml)) !== null) {
      ...
      while ((liMatch = liRegex.exec(listContent)) !== null) {
        const itemContent = parseInlineHtml(liMatch[1]);
        if (itemContent)
          items.push({ content: itemContent, number: itemIndex++ });
      }
      if (items.length > 0)
        elements.push({ type: "orderedList", items: items });
  ...
  const renderIntroductionSection = () => (
    <View style={styles.sectionContainer}>
      ...
      <Text style={styles.paragraph}>
        This application is a comprehensive platform designed to streamline
        workflows and operational management. It provides a structured approach
        to handle tasks, ensuring smooth operations across all stakeholders.
      </Text>

      <Text style={styles.paragraph}>
        By integrating robust workflows for task creation, job sequencing, and
        resolution, the application facilitates seamless coordination among
        users, supervisors, and administrators. It ensures all aspects of
        management are handled efficiently, reducing downtime and enhancing
        service quality.
      </Text>
      ...
      <View style={styles.bulletListContainer}>
        {[
          [
            ...
            "Covers the full lifecycle of operations, from initiation to completion.",
          ],
          [
            "Streamlined Task Processes:",
            "Simplifies issue reporting and tracks resolution in real-time.",
          ],
          [
            "Role-Based Collaboration:",
            "Enables efficient communication and task allocation between roles.",
          ],
          [
            "Automated Notifications:",
            "Provides real-time alerts for new tasks, status updates, and escalations.",
          ],
          [
            "Data Transparency:",
            "Tracks all updates and actions, creating a clear and auditable workflow history.",
          ],
        ].map(([label, desc], idx) => (
          <View key={idx} style={styles.bulletListItem}>
            <Text style={styles.bulletPoint}>{"\u2022"}</Text>
      ...
      <Text style={styles.paragraph}>
        This document provides an in-depth look into the workflows that drive
        the application, focusing on how they simplify operations while
            ...
            <Page size="A4" style={styles.page}>
              <View style={styles.sectionContainer}>
                ...
                <Text style={styles.paragraph}>
                  ...
                  flows within the application. Each service includes
                  step-by-step instructions, workflow descriptions, and
                ...
                <View style={styles.infoBox}>
                  ...
                  <Text style={styles.paragraph}>
                    {"\u2022"} Includes operational procedures and best
                    practices
                  </Text>
                </View>
              </View>
            ...
            <Page size="A4" style={styles.page}>
              <View style={styles.sectionContainer}>
                ...
                <Text style={styles.paragraph}>
                  ...
                  application backend. The API follows RESTful conventions and
      ...
      <Dialog
        header={
          pdfReady
            ...
            : `Generate ${projectName} Technical Documentation`
        }
        visible={show}
        onHide={onHide}
