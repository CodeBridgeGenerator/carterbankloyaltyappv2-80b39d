...
// Once you download the image, import it like this:
import dashboardAnim from "../../assets/media/Dashboard Animation.svg";
      ...
      <div className="flex flex-col bg-white">
        <div className="flex flex-col mt-0 mr-0 w-full max-md:mt-10 max-md:max-w-full">
          <div className="flex w-full bg-indigo-50 min-h-[296px] items-center px-12 max-md:px-5">
            {/* Image Section */}
            <img
              // src={welcomeImg} // Use this once the local file is added
              loading="lazy"
              src={dashboardAnim}
