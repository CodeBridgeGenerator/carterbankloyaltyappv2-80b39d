...
module.exports = {
    apps: [
        {
            // name: cwd + "-" + "carterbankloyaltyappv2",
            script: 'src/',
            instance_var: 'INSTANCE_ID',
            appendEnvToName: true,
            // Standard Output (console.log) will go here
            //out_file: "/home/ubuntu/app/logs/carterbankloyaltyappv2stg-out.log",
            // Error Output (console.error) will go here
            //error_file: "/home/ubuntu/app/logs/carterbankloyaltyappv2-stg-error.log",
